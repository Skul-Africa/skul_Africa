...
export default function SettingsPage() {
  ...
  return (
    <div className="bg-[#DDE5FF] min-h-screen p-4">
      {/* Header */}
      <div className="mb-4 flex items-center justify-between">
        <div>
          <h1 className="text-[#303972] font-bold text-2xl mb-1">Settings</h1>
          <div className="flex items-center gap-2 bg-white rounded-full px-4 py-2 shadow-md w-[175px]">
            <Search className="text-[#4D44B5] w-3 h-3" />
            <input
              type="text"
              placeholder="Search here..."
              className="flex-1 outline-none text-[#A098AE] placeholder:text-[#A098AE]"
            />
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-[25px] p-4 shadow-md mb-3">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[#636363] font-bold text-base">
      ...
      <div className="bg-white rounded-[5px] shadow-md p-4">
        <div className="flex gap-4">
          ...
          <div className="w-[240px] space-y-2">
            {settingsCategories.map((category) => (
              ...
              >
                ...
                <span className="text-[#636363] text-lg font-normal flex-1 text-left">
                  {category.label}
                </span>
          ...
          <div className="flex-1 border border-[#E4E4E4] rounded-lg p-4">
            <div className="mb-4">
              <h2 className="text-xl font-light mb-3">Data & Privacy</h2>
              <div className="border-t-2 border-[#F8F8F8] mb-3"></div>
              <h3 className="text-lg font-normal text-[#2C2C2C] mb-1">
            ...
            <div className="space-y-0 border border-[#EAEAEA] rounded-lg overflow-hidden">
              {/* Header Row */}
              <div className="bg-[#F5F8F7] border-b border-[#E7E7E7] p-3 flex items-center">
                <div className="w-24">
                  <p className="text-lg font-medium text-[#2C2C2C]">Login Alerts</p>
                  <p className="text-[#262626] font-light">Founder</p>
                </div>
              ...
              {/* Second Row */}
              <div className="bg-white border-b border-[#E7E7E7] p-3 flex items-center">
                <div className="w-24">
                  <p className="text-lg font-medium text-[#2C2C2C]">Login Alerts</p>
                  <p className="text-[#262626] font-light">Assistant</p>
                </div>
                <div className="flex-1 flex items-center gap-2 justify-end">
                  <div className="w-30 border border-[#D4D4D4] rounded-lg p-2">
                    <p className="font-semibold text-[#262626]">Full Access</p>
                  </div>
                  <div className="w-30 border border-[#D4D4D4] rounded-lg p-2">
                    <p className="font-semibold text-[#262626]">Only View</p>
                  </div>
                </div>
              </div>

              {/* Third Row - Expanded */}
              <div className="bg-[#F5F8F7] border-b border-[#E7E7E7] p-3">
                <div className="flex items-start mb-3">
                  ...
                  <div className="flex-1 flex items-center gap-2 justify-end">
                    ...
                    />
                    <div className="w-30 border border-[#D4D4D4] rounded-lg p-2 bg-white">
                      <p className="font-semibold text-[#262626]">Only View</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex gap-4 justify-center mb-3">
                  <div className="text-center">
                    <div className="w-4 h-4 bg-gray-200 rounded mb-1 mx-auto"></div>
                  </div>
                  <div className="text-center">
                    <div className="w-4 h-4 bg-gray-200 rounded mb-1 mx-auto"></div>
                  </div>
                ...
                <div className="flex justify-center">
                  <button className="border border-[#D4D4D4] rounded-lg px-3 py-2 bg-white flex items-center gap-2 hover:bg-gray-50 transition-colors">
                    <Plus className="w-3 h-3 text-[#262626]" />
                    <span className="font-semibold text-[#262626]">Add Member</span>
                  </button>
                </div>
              </div>
            </div>
