...
export default function EduCentral404() {
  ...
  const goHome = () => {
    // In a real app, this would navigate home
  ...
  return (
    <div className={`min-h-screen transition-all duration-500 relative overflow-hidden ${
      ...
      <div className="absolute inset-0 opacity-10">
        ...
        <div className={`absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] rounded-full ${
          isDarkMode 
      ...
      {floatingElements.map((element) => (
        <div
          ...
          className={`absolute pointer-events-none select-none ${
            isDarkMode ? 'text-white/10' : 'text-slate-400/20'
          }`}
          style={{
            left: `${element.x}%`,
            top: `${element.y}%`,
      ...
      <div className="relative z-10 flex flex-col items-center justify-center px-6 py-12 max-w-4xl mx-auto text-center min-h-[calc(100vh-200px)]">
        ...
        <div className="mb-8 relative">
          <div className={`text-8xl md:text-9xl font-bold leading-none mb-4 ${
            isDarkMode 
        ...
        <div className="w-full max-w-md mb-8">
          <div className={`relative backdrop-blur-lg rounded-2xl p-2 shadow-xl ${
            isDarkMode 
            ...
            <div className="flex items-center">
              ...
              <input
                ...
                className={`flex-1 px-3 py-2 bg-transparent border-none outline-none placeholder-gray-400 ${
        ...
        {/* Helpful Links */}
        <div className={`backdrop-blur-lg rounded-2xl p-6 shadow-xl max-w-2xl w-full ${
          isDarkMode 
            ? 'bg-white/10 border border-white/20' 
            : 'bg-white/90 border border-blue-200'
        }`}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className={`p-4 rounded-xl transition-all duration-300 hover:scale-105 cursor-pointer ${
              isDarkMode ? 'bg-white/10 hover:bg-white/20' : 'bg-blue-50 hover:bg-blue-100'
            }`}>
      ...
      <div className={`absolute top-1/2 right-1/3 w-3 h-3 rounded-full animate-bounce ${
